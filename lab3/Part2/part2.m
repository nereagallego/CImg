...
hdr = hdrread('../Part1/Results/own_photos/hdr_image.hdr');
...
for key=keys
    ...
    imwrite( ...
        ...
        "Results/own_photos/tonemapped_reinhard_key_" + key + ".png" ...
        )
...
for burn=burns
    ...
    imwrite( ...
        ...
        "Results/own_photos/tonemapped_reinhard_burn_" + burn + ".png" ...
        )
